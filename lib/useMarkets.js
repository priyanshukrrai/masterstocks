...
export function useMarkets() {
  ...
  useEffect(() => {
    ...
    // own sampling lag (crypto ~10s, equities ~8s); the data provider's inherent
    // feed delay is a separate thing and cannot be removed on a free source.
    const cg = setInterval(loadCrypto, 10000);
